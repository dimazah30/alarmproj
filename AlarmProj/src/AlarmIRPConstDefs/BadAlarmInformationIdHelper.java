...
/**
* AlarmIRPConstDefs/BadAlarmInformationIdHelper.java .
...
abstract public class BadAlarmInformationIdHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (AlarmIRPConstDefs.BadAlarmInformationIdHelper.id (), "BadAlarmInformationId", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    AlarmIRPConstDefs.BadAlarmInformationId value = new AlarmIRPConstDefs.BadAlarmInformationId ();
